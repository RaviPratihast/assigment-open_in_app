      ...
      <div className="flex flex-col lg:flex-row h-screen bg-gray-100">
        ...
        <div className="lg:w-1/2 flex flex-col justify-center items-center ">
          <div className="flex flex-col justify-evenly ">
            <h2 className="text-4xl flex font-bold mb-4">Sign In</h2>
            <p className="text-base font-normal">Sign in to your account</p>
            ...
            {/* sign in container */}
            <div className="bg-white p-4 lg:p-8 rounded-lg shadow-md w-full lg:w-96 border mt-5">
              <div>
                <div className="mb-4">
                  <label
                    htmlFor="email"
                  ...
                  <input
                    type="email"
                    id="email"
                    className=" bg-gray-200 rounded-lg text-base  font-normal border-gray-400 p-2 w-full focus:outline-none"
                ...
                <div className="mb-4">
                  ...
                  <input
                    type="password"
                    id="password"
                    className=" bg-gray-200 rounded-lg text-base font-normal p-2 w-full focus:outline-none"
                    placeholder="Enter your password"
                  />
                </div>
                <p className="text-base font-normal text-buttonBlue cursor-pointer">
                  Forgot Password?
                </p>
                <Button className="rounded-lg w-full bg-buttonBlue h-10 text-white text-base font-semibold mt-4">
                  Sign In
                </Button>
              </div>
            </div>
            <div className="flex justify-center mt-4 gap-1">
              <p className="flex text-gray-500 text-base font-normal">
                Don't have account?
              </p>
              <span className="text-buttonBlue  text-base font-normal cursor-pointer">
                Register here
              </span>
            </div>
          </div>
